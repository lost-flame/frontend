...
const DisplayProductsDetails = () => {
    ...
    const productApi = async () => {
        try {
            const response = await fetch(`http://localhost:5000/product/getProduct/${location.state}`, {
                method: 'GET',
    ...
    const handleCart = async () => {
        try {
            const response = await fetch(`http://localhost:5000/product/addCartProduct`, {
                method: 'POST',
                    ...
                    <div className='w-100 p-0 m-0 bg-danger'>
                        <center>
                            ...
                            <div className='w-75 p-2 m-0 bg-body'>
                                <img className='w-100' src={`http://localhost:5000/uploads/${productData.productimg}`} alt='img' />
                                {
